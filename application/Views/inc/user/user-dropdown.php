...
<ul class="navbar-nav ms-auto mb-2 mb-md-0" id='nav-items-2'>
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu user-dropdown-menu" aria-labelledby="user-options-lg" style='left: -95px; width: 205px'>
            ...
            <li><a class="dropdown-item hover-primary" href="<?=URLROOT?>/write"><i class="fas fa-plus pe-2 py-2"></i> New Form</a></li>
            <li><a class="dropdown-item hover-primary" href="<?=URLROOT?>/home"><i class="far fa-newspaper pe-2 py-2"></i> Submitted Forms</a></li>
            <li>
