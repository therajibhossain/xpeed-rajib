...
<form action="<?= URLROOT ?>/user/login" method='POST' id='page-form' class='mt-3'>
   ...
   <div class="form-group mb-3">
      ...
      <input type="text" class="form-control <?= !empty($data['email_or_username_err']) ?  'is-invalid' : ''?>" name='email_or_username' placeholder="Email or Username" value="<?=ht('rajib')?>">
   ...
   <div class="form-group mb-4">
      ...
      <div class="input-group">
         <input type="password" id='pwd-input' class="form-control <?= !empty($data['password_err']) ?  'is-invalid' : ''?>" name='password' placeholder="Password" value="<?=ht('12345678')?>">
